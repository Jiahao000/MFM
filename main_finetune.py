...
def parse_option():
    parser = argparse.ArgumentParser('fine-tuning and evaluation script', add_help=False)
...
def main(config, log_writer):
    ...
    for epoch in range(config.TRAIN.START_EPOCH, config.TRAIN.EPOCHS):
        ...
        train_one_epoch(config, model, criterion, data_loader_train, optimizer, epoch, mixup_fn, lr_scheduler, log_writer)
